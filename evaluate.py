...
sys.path.append("/mnt/massive/wangce/LightSD/AdcSR-main")
import os
...
def evaluate(in_path, ref_path, out_path, ntest):
    ...
    if ref_path is not None and len(lr_path_list) >= 1000:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--in_path",
        type=str,
        default="/mnt/massive/wangce/LightSD/AdcSR-main/result/V1.11.4_val_16bit",
    )
    parser.add_argument(
        "-r",
        "--ref_path",
    ...
    parser.add_argument(
        ...
        "--out_path",
        type=str,
        default="./logs/V1.11.4_val_16bit_val",
    )
